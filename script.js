function calcular(n1,n2){
    ...
    switch(selector){
        case '+':
            ...
            }else{document.getElementById("resultado").innerHTML= `O resultado da soma de ${n1} + ${n2} é = ${calculo}`}
            break
        case '-':
            calculo = (n1-n2)
            if(Number.isNaN(calculo)){
        ...
        case '/':
            ...
            }else{document.getElementById("resultado").innerHTML= `O resultado da divisão de ${n1} / ${n2} é = ${calculo}`}
            break
        case '%':
            calculo = ((n1*n2)/100)
            document.getElementById("resultado").innerHTML= `${n1}% de ${n2} é igual à = ${calculo}`
            break
    }
}